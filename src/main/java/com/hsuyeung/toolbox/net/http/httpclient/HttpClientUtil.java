package com.hsuyeung.toolbox.net.http.httpclient;
...
public class HttpClientUtil {
     ...
     * @return {@link HttpClientResult}
     */
    public HttpClientResult doPost(String url) throws IOException {
     ...
     * @return {@link HttpClientResult}
     */
    public HttpClientResult doPost(String url, Map<String, String> headers, Map<String, String> params) throws IOException {
        // 创建http对象
     ...
     * @return {@link HttpClientResult}
     */
    public HttpClientResult getHttpClientResult(CloseableHttpClient httpClient, HttpRequestBase httpMethod) throws IOException {
        // 执行请求
